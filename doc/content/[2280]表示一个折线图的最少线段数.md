...
<img alt="" src="https://assets.leetcode.com/uploads/2022/03/30/1920px-pushkin_population_historysvg.png" style="width: 500px; height: 313px;"> <p>请你返回要表示一个折线图所需要的 <strong>最少线段数</strong>&nbsp;。</p> </img>
...
<div><div>Related Topics</div><div><li>几何</li><li>数组</li><li>数学</li><li>数论</li><li>排序</li></div></div><br><div><li>👍 23</li><li>👎 0</li></div>